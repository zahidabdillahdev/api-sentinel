...
- Backup and destructive restore remain operator-only workflows outside the web
  UI. Explicit confirmation, safety snapshots, and isolated rehearsals prevent
  routine workspace actions from exposing disaster-recovery controls.
